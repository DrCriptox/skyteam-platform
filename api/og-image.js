  ...
  return new ImageResponse(
    {
      ...
      props: {
        style: {
          ...
          background: 'linear-gradient(135deg, #0a0a12 0%, #0a0a12 50%, #0a0a12 100%)',
        ...
        children: [
          ...
          // Features row
          {
            ...
            props: {
              ...
              children: [
                { type: 'div', props: { style: { background: 'rgba(201,168,76,0.1)', border: '1px solid rgba(201,168,76,0.3)', borderRadius: 20, padding: '10px 22px', fontSize: 15, fontWeight: 700, color: '#C9A84C' }, children: '🤖 6 Agentes IA' } },
