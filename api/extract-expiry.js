      ...
      body: JSON.stringify({
        ...
        messages: [{
          ...
          content: [
            ...
            {
              type: 'text',
              text: 'Analiza esta captura de pantalla del perfil de Innova (8innova.biz). Extrae estos 5 datos: 1) DÍAS RESTANTES: el número que aparece en el badge rojo "X días restantes". 2) FECHA DE VENCIMIENTO: fecha exacta de expiración si aparece. 3) USUARIO INNOVA: el código/username que aparece debajo del nombre completo (ej: ANGEL2026, letras y números, NO es el nombre completo). 4) CLASIFICACIÓN ACTUAL: el texto que aparece debajo del label "Clasificación Actual" (ej: NOVA DIAMOND, NOVA 5K, INN 200, etc.). 5) SPONSOR/PATROCINADOR: el texto que aparece debajo de la palabra "Patrocinador" (ej: LEGEND). Responde ÚNICAMENTE con JSON válido sin texto adicional: { "found": true, "days_remaining": 173, "expiry_date": "YYYY-MM-DD o null", "username": "ANGEL2026 o null", "classification": "NOVA DIAMOND o null", "sponsor": "LEGEND o null" } — Si no encuentras días restantes ni fecha, responde: { "found": false }'
            }
          ]
        }]
      })
